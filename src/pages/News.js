...
import HeroNews from "../components/layout/HeroNews";

function NewPage(props) {
  return (
    <div className="min-h-screen flex flex-col justify-between">
      <section className="flex-shrink-none ">
        <Header />
        <HeroNews />
      </section>

      <section className="my-10 flex-1 ">
        <div className="lg:mx-20 mx-4 py-10">
          <Row gutter={[10, 10]}>
            <Col xs={24} md={6}>
              ...
              <Row gutter={[5, 5]} className="flex justify-end w-full">
                <Col xs={24} md={12}>
                  ...
                  <h2 className="hero-text text-black lg:text-xl text-lg font-extrabold">
                    ...
                    >
                      Shield Finance Is A Community Project On Binance Smart
                      Chain
                    </a>
                  </h2>
                </Col>
